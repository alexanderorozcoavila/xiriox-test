...
if dir_encrypt == '/home/xirioxinf/ERROR':
    sys.exit()
...
id_embarcacion = configuracion['ID']['id_embarcacion'] # obtiene el código único de hardware
##############################################
...
hddFolder = os.listdir('/home/xirioxinf/')
#if 'Ext1' in hddFolder and 'Ext2' in hddFolder or 'Ext3' in hddFolder:
if 'Ext1' in hddFolder and 'Ext2' in hddFolder:
...
if os.stat(path+'metadata/METADATA.csv').st_size == 0:
	csvfile = open(path+'metadata/METADATA.csv', 'a') # crea un archivo para guardar los metadatos
	csvfile.write('ID Nave,ID DRI,Fecha,Hora,Latitud,Longitud,Velocidad (nudos),Rumbo (grados),Error (m),CAM 1,CAM 2,CAM 3,CAM 4,CAM 5,CAM 6,CAM 7,CAM 8\n') # primera línea de encabezado de archivo
	csvfile.close() # cierra el archivo 

if os.stat(path2+'metadata/METADATA.csv').st_size == 0:
	csvfile2 = open(path2+'metadata/METADATA.csv', 'a') # crea un archivo para guardar los metadatos
	csvfile2.write('ID Nave,ID DRI,Fecha,Hora,Latitud,Longitud,Velocidad (nudos),Rumbo (grados),Error (m),CAM 1,CAM 2,CAM 3,CAM 4,CAM 5,CAM 6,CAM 7,CAM 8\n') # primera línea de encabezado de archivo
	csvfile2.close() # cierra el archivo 
