        ...
        if respuesta == 0:
            ...
            while True: # ciclo para ir recibiendo los frames
                ...
                if ret: # si es recibido de forma correcta se redimensiona el frame
                    ...
                    #print(w, h)
                    cv2.putText(ret_frame, "CAM "+str(var2+1)+" 10.1.1."+var+"  - FPS: "+str(fps)+'    '+bitrate_cam+'    '+str(w)+'x'+str(h), (6, 31), cv2.FONT_HERSHEY_DUPLEX, 2, (0,0,0), 2,lineType=cv2.LINE_AA)
                    cv2.putText(ret_frame, "CAM "+str(var2+1)+" 10.1.1."+var+"  - FPS: "+str(fps)+'    '+bitrate_cam+'    '+str(w)+'x'+str(h), (5, 30), cv2.FONT_HERSHEY_DUPLEX, 2, (255,255,255), 2,lineType=cv2.LINE_AA)
